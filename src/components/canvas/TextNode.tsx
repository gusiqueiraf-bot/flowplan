    ...
    <>
      ...
      <div 
        ...
        style={{
          ...
          backgroundColor: isHovered || isEditing || selected ? 'rgba(255, 255, 255, 0.4)' : 'transparent',
          border: isHovered || isEditing || selected ? '1px dashed #cbd5e1' : '1px solid transparent',
        }}
      ...
      >
        {isEditing ? (
          ...
          <div className="w-full h-full whitespace-pre-wrap flex items-center justify-center text-center cursor-text text-gray-800 font-semibold leading-snug break-words">
            {data.text || 'Texto (duplo clique para editar)'}
          </div>
        )}
